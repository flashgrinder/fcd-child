...
function init() {
  ...
  var screenLayerEntryOne = document.querySelector(".screen-entry__layer--one");
  var screenLayerEntryTwo = document.querySelector(".screen-entry__layer--two");
  var screenLayerEntryThree = document.querySelector(".screen-entry__layer--three");
  var screenLayerEntryFour = document.querySelector(".screen-entry__layer--four");
  var screenBrand = document.querySelector(".js-screen-brand");
  var screenLayerBrandOne = document.querySelector(".screen-brand__layer--one");
  var screenLayerBrandTwo = document.querySelector(".screen-brand__layer--two");
  var screenLayerBrandThree = document.querySelector(".screen-brand__layer--three");
  var screenLayerBrandFour = document.querySelector(".screen-brand__layer--four");
  var screenHackerman = document.querySelector(".js-screen-hackerman");
  var screenLayerHackermanOne = document.querySelector(".screen-hackerman__layer--one");
  var screenLayerHackermanTwo = document.querySelector(".screen-hackerman__layer--two");
  var screenLayerHackermanThree = document.querySelector(".screen-hackerman__layer--three");
  var screenMarketing = document.querySelector(".js-screen-marketing");
  var screenLayerMarketingOne = document.querySelector(".screen-marketing__layer--one");
  var screenLayerMarketingTwo = document.querySelector(".screen-marketing__layer--two");
  var screenLayerMarketingThree = document.querySelector(".screen-marketing__layer--three");
  var screenIt = document.querySelector(".js-screen-it");
  var screenLayerItOne = document.querySelector(".screen-it__layer--one");
  var screenLayerItTwo = document.querySelector(".screen-it__layer--two");
  var screenLayerItThree = document.querySelector(".screen-it__layer--three");
