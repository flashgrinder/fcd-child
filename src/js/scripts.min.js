...
function init() {
  ...
  var sections = _gsap.gsap.utils.toArray(".screen");

  var container = document.querySelector(".horizontal-container");

  var horizontalScroll = _gsap.gsap.to(container, {
    x: function x() {
  ...
  var tlScreenEntry = _gsap.gsap.timeline({
    ...
    scrollTrigger: {
      ...
      scrub: 1 // snap: 1 / (sections.length - 1),
  ...
  tlScreenBrand.from(".js-screen-brand__layer--one", 1.7, {
    x: 220
  }, '-=1.7').from(".js-screen-brand__layer--two", 1.5, {
    x: 260
  }, '-=1.5').from(".js-screen-brand__layer--three", 1.3, {
    x: 280
  }, '-=1.3').from(".js-screen-brand__layer--four", 1.2, {
    x: 300
  }, '-=1');
}
