...
function init() {
  ...
  _ScrollTrigger.ScrollTrigger.matchMedia({
    "(min-width: 1024px)": function minWidth1024px() {
      ...
      var screenLayer = document.querySelectorAll(".screen__layer");
      screenLayer.forEach(function (item) {
        var speedItem = item.dataset.speed;
        var itemParent = item.closest('.screen');
        var itemParentWidth = item.closest('.screen').offsetWidth;
        ...
        _ScrollTrigger.ScrollTrigger.create({
          ...
          start: 'top left',
            ...
            return "+=" + itemParentWidth;
          },
          onUpdate: function onUpdate(instance) {
            _gsap.gsap.to(item, {
              x: speedItem * instance.progress
            });
          }
        });
      });
