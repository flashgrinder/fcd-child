                            ...
                            if( have_posts() ) : 
                                ...
                                <article class="review-card js-reveal gs-reveal">
                                    ...
                                    <footer class="review-card__footer">
                                        <?php $review_case = get_field('review_case'); ?>
                                        <?php if(!empty($review_case)) : ?>
                                            <a href="<?= esc_url( $review_case['url'] ); ?>" class="review-card__button button button--primary button--icon" target="_blank">
                                                <?= esc_html( $review_case['title'] ); ?>
                                                ...
                                                <article class="case-card">
                                                    ...
                                                    <footer class="case-card__footer">
                                                        <div class="case-card__action">
                                                            <a href="<?php echo esc_url($case_permalink); ?>" class="case-card__button button button--primary" data-id-case="<?php echo $cases_slider_item->ID; ?>">
                                                                Посмотреть кейс
                                                            </a>
                                                        </div>
                                                    </footer>
