<?php
    ...
    add_action( 'wp_head', function() {
        ...
        ?>
            ...
            <!-- Google tag (gtag.js) -->
            <script async src="https://www.googletagmanager.com/gtag/js?id=UA-111282443-7"></script>
            <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());

            gtag('config', 'UA-111282443-7');
            </script>
            <!-- Google tag (gtag.js) -->
    ...
    add_action( 'wp_footer', function() {
        ...
        <script>
            ...
            })(window,document,'https://cdn-ru.bitrix24.ru/b12397222/crm/site_button/loader_1_ajou08.js');
        </script>
